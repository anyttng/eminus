...
public final class BiomeWindow implements BiomeResolver {
    ...
    public static BiomeWindow capture(BiomeResolver source, int sectionX, int sectionY, int sectionZ, long seed) {
    ...
    public @Nullable Holder<Biome> at(int x, int y, int z) {
        ...
        return manager.getBiome(blockOrigin(originX) + x, blockOrigin(originY) + y, blockOrigin(originZ) + z);
    }
